import{P as e,M as t,N as a,O as n,x as s,i as o,k as c,a as r}from"./7dd4418c.js";const d={title:"Error: Page not found",description:null,image:null};class l extends e{connectedCallback(){super.connectedCallback(),t("name","render:status_code","404"),a({...this.defaultMeta,...d})}disconnectedCallback(){n("name","render:status_code"),super.disconnectedCallback()}}let i=class extends l{render(){return s`
      <section>
